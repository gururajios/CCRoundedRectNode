...
-(id) init
{
	if( (self=[super init])) {
        ...
        CCSprite *sp = [CCSprite spriteWithFile:@"background.jpf"];
        sp.position = ccp((s.width)*0.5, (s.height)*0.5f);
		...
		shareRectNode.position = ccp(s.width*0.5-layer_width*0.5f, s.height*0.5-layer_height*0.5f);
